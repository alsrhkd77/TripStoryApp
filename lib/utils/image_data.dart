...
class ImageData {
  ...
  static Future<DateTime> getLocalImageDateTime(String path) async {
    Map<String, IfdTag> data =
        await readExifFromBytes(await new File(path).readAsBytes());
  ...
  static Future<DateTime> getNetworkImageDateTime(String url) async {
  ...
  static Future<Map<String, double>> getLocalImageLocation(String path) async {
