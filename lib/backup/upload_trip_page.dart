...
class UploadTripPage extends StatefulWidget {
  @override
  _UploadTripPageState createState() => _UploadTripPageState();
}

class _UploadTripPageState extends State<UploadTripPage> {
